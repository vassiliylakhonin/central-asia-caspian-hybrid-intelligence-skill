...
**Last updated:** 2026-05-18 (Wave 8: illustrative source-conflict-surfacing demonstrator on KZ→RU CHPL-circumvention volume estimates added; source-anchored ratio now 8 of 16 flagship examples = 50%; B2.1 still met but at the threshold with no margin).
