...
🟡 **B5. Reviewer actions are uniformly worded.** "Subject to internal policy and regulatory review" appears almost verbatim across roles. A compliance officer's actions are not the same shape as a logistics operator's; the current memos sometimes flatten that.
