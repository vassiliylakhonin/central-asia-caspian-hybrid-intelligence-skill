...
2. The UK has published explicit sanctions guidance for Kazakh businesses (June 2025; updated August 2025) that names the *exact* circumvention pattern — Kazakh firm receives Russian-importer orders for UK-sanctioned goods, orders from UK suppliers without disclosing Russian end-user, re-exports to Russia — as a designation-eligible behaviour, and identifies the Common High Priority List (CHPL) as particularly concerning [S5]. Note: this is published UK guidance on behaviour at risk of designation, not a record of UK designations on this specific pattern — actual UK designations of KZ banking parties for this circumvention pattern remain narrower than the guidance scope per the bank-designation record visible in [S3]. The gap between guidance scope and designation record is itself the supervisory-direction signal.
