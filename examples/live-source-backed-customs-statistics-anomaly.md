...
`Verified` [S1, S3]: A persistent gap between Kazakhstan's official bilateral export statistics and Russian Federal Customs Service import records for the same flows — a mirror-statistic anomaly — is a documented indicator of deliberate under-reporting, misclassification, or re-routing in KZ–RU trade. Post-February 2022, this pattern has been specifically associated with dual-use goods circumvention in KSE/CREA, IFI, and FATF/EAG research [S3, S5].
